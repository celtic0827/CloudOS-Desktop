  ...
  return (
    <div
      ...
      className={`
        ...
        ${isDragOver ? 'border-amber-500 shadow-[0_0_30px_-5px_rgba(245,158,11,0.3)] bg-white/5 scale-[1.02] z-10' : 'border-white/5 hover:bg-[#111]/60 hover:border-amber-500/30 hover:shadow-[0_8px_32px_-8px_rgba(245,158,11,0.15)]'}
